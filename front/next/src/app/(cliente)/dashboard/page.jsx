    ...
    <>
      <div className='w-full bg-black'>
          ...
          <div className="relative z-10 md:my-20 my-5">
            ...
            <div className="relative overflow-hidden">
              <button
                ...
                className="absolute left-[25px] top-1/2 -translate-y-1/2 z-30 bg-red-600 hover:bg-red-700 p-2 rounded-full cursor-pointer"
              >
              ...
              <button
                ...
                className="absolute right-[25px] top-1/2 -translate-y-1/2 z-30 bg-red-600 hover:bg-red-700 p-2 rounded-full cursor-pointer"
              >
                <svg width="3em" height="3em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <div className="relative group">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          ...
                          <button className={`
                             w-full bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all duration-300
        ...
        <main className="container mx-auto px-4 py-8">
          <p className='text-center text-white mb-7 text-4xl'>Top Películas</p>
