...
export default function SearchComp({ onClick }) {
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-6 flex-1 justify-end">
                        ...
                        {token ? (
                            ...
                            <button onClick={onClick} className="flex items-center space-x-2 bg-red-600 text-white px-6 py-3 rounded-md transition hover:bg-red-700 transition-colors cursor-pointer">
